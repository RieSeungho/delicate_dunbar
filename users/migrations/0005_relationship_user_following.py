    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('to_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='followed_relationships', to=settings.AUTH_USER_MODEL, verbose_name='팔로우 요청의 대상')),
            ],
        ),
        migrations.AddField(
            model_name='user',
